def sort_the_pile(pile_of_towels, weekly_used_towels):
    for used_towels_number in weekly_used_towels:
        app = pile_of_towels[-used_towels_number:]
        app.sort(reverse=True)
        pile_of_towels = pile_of_towels[:len(pile_of_towels) - used_towels_number] + app
